...
Note: If the host machine is based on the aarch-64 architecture, please append the -aarch64 suffix to the image names of TDengine and TDgpt in the docker-compose.yml file (e.g., tdgpt-aarch64:3.3.6.0 ).
## 5. Running the Demo
